...
class PresetMonitorSignal(Signal):
    ...
    def put(self, value, *, timestamp=None, force=False, metadata=None):
        ...
        if self.parent._monitor.s.name in ['Time', 'Seconds']:
...
scaler1 = LocalScalerCH('6idb1:scaler1', name='scaler1',
                        labels=('detectors',))
scaler1.monitor = 'Seconds'
scaler1.select_read_channels()
scaler1.select_plot_channels()
sd.baseline.append(scaler1)

scaler2 = LocalScalerCH('6idb1:scaler2', name='scaler2',
                        labels=('detectors',))
scaler2.monitor = 'Seconds'
scaler2.select_read_channels()
scaler2.select_plot_channels()
# sd.baseline.append(scaler2)
