...
class SRS830Device(Device):
    # Time constant
    time_multiplier = Component(
        EpicsSignal, "TC1", kind="omitted", string=True
    )
    ...
    time_filter_readback = Component(
        EpicsSignalRO, "LPFilter_rbv", kind="config"
    )
    time_filter_setpoint = Component(
        EpicsSignal, "LPFilter", kind="config", string=True
    )

    time_constant = Component(EpicsSignalRO, "TC.SVAL", kind="config")

    # Gain
    gain_multiplier = Component(
        EpicsSignal, "Sens1", kind="omitted", string=True
    )
    ...
    reserve_setpoint = Component(
        EpicsSignal, "ResvCh", kind="config", string=True
    )

    # Notch filter
    notch_readback = Component(EpicsSignalRO, "NotchFilter_rbv", kind="config")
    notch_setpoint = Component(
        EpicsSignal, "NotchFilter", kind="config", string=True
    )

    # AUX output voltage
    aux_out1 = Component(
        EpicsSignal, "AuxOutCh1_rbv", write_pv="AuxOutCh1", kind="config"
    )
    aux_out2 = Component(
        EpicsSignal, "AuxOutCh2_rbv", write_pv="AuxOutCh2", kind="config"
    )
    aux_out3 = Component(
        EpicsSignal, "AuxOutCh3_rbv", write_pv="AuxOutCh3", kind="config"
    )
    aux_out4 = Component(
        EpicsSignal, "AuxOutCh4_rbv", write_pv="AuxOutCh4", kind="config"
    )

    # Reference
    frequency = Component(
        EpicsSignal, "Freq.VAL", write_pv="SetFreq", kind="config"
    )
    phase = Component(
        EpicsSignal, "Phas.VAL", write_pv="SetPhas", kind="config"
    )
    amplitude = Component(
        EpicsSignal, "Ampl.VAL", write_pv="SetAmpl", kind="config"
    )
    ...
    read_parameters = Component(
        EpicsSignal, "SlowRead", kind="config", string=True
    )
...
class SRS810Device(Device):
    ...
    read_scan = Component(
        EpicsSignal, "ReadX.SCAN", kind="config", string=True
    )
