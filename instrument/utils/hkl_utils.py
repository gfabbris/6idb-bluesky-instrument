...
def set_experiment(user=None, proposal_id=None, sample=None):
    ...
    proposal_id=_proposal_id if proposal_id else input(f"Proposal ID [{_proposal_id}]: ") or _proposal_id
    ...
    if pathlib.Path("startup_experiment.py").exists():
        for line in fileinput.input(['startup_experiment.py'], inplace=True):
        ...
        f= open('startup_experiment.py', 'w')
