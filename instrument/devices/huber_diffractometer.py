__all__ = "fourc psic p09 sixcq sixcpsi sixcinc _geom_ sixcpsi_name".split()
...
class SixcInc(E6C):
    ...
    """
    # the reciprocal axes are called "pseudo" in hklpy
    incidence = Cpt(PseudoSingle, '')
    arc = Cpt(PseudoSingle, '')
...
sixcinc = SixcInc("", name="sixcinc", engine="incidence")
