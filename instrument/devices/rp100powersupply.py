...
#    voltage_pv = Component(EpicsSignal, "VoltageLimit1.INPA")    
    voltage_pv = Component(EpicsSignal, "VoltageLimit1.A")
...
#    voltage_pv = Component(EpicsSignal, "VoltageLimit2.INPA")
    voltage_pv = Component(EpicsSignal, "VoltageLimit2.A")
...
rp100 = RP100_Device("iocRazorbill:D1:", name="rp100")
#sd.baseline.append(rp100)